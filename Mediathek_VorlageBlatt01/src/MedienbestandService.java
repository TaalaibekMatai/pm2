...
interface MedienbestandService extends ObservableService
{
	...
	/**
	 * Entfernt ein Medium aus dem Medienbestand, z.B. wenn es verloren gegangen ist
	 * oder so veraltet, dass es von den Mediathek-Kunden nicht mehr nachgefragt
	 * wird.
	 * 
	 * @param medium Ein zu entfernendes Medium
	 * 
	 * @require medium != null
	 * @require entferneMedium(medium)
	 * 
	...
	/**
	 * Informiert diesen Service darüber, dass Medien von einem Werkzeug geändert
	 * wurden. Eine Implementation wird daraufhin wahrscheinlich alle
