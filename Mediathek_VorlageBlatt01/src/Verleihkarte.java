...
class Verleihkarte
{
	 ...
	 * @param ausleihdatum Ein Datum, an dem der Kunde das Medium ausgeliehen hat.
	 * 
	...
	public int hashCode()
	{
		final int prime = 31;
		int result = 1;
		result = prime * result + ((_ausleihdatum == null) ? 0 : _ausleihdatum.hashCode());
		result = prime * result + ((_entleiher == null) ? 0 : _entleiher.hashCode());
	...
	public boolean equals(Object obj)
	{
		...
		if (obj instanceof Verleihkarte)
		{
			...
			if (other.getAusleihdatum().equals(_ausleihdatum) && other.getEntleiher().equals(_entleiher)
