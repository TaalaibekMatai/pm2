...
public class VerleihServiceImplTest
{
    ...
    public void testNochEinTestFall1()
    {
    	...
    	medien.add(_shape);
    	medien.add(_bad);
    	_verleihService.verleiheAn(_roger, medien, Datum.heute());
    	assertEquals(_roger, _verleihService.getEntleiherFuer(_bad));
    ...
    public void testNochEinTestFall2()
    {
    	...
    	medien.add(_bad);
    	_verleihService.verleiheAn(_roger, medien, Datum.heute());
    	assertFalse(_verleihService.istVerleihenMoeglich(_brian, medien));
    }
